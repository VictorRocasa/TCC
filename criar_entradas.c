...
void gravar_entrada_aleatoria(unsigned int t, unsigned int n);//gera uma entrada com t elementos variando de 0 a n
...
int main(){
	...
	skipfor: gravar_entrada_ordenada(1000000000);
